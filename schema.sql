...
CREATE TABLE IF NOT EXISTS events (
  ...
  name        TEXT    NOT NULL,
  description TEXT,
  from_date   TEXT,               -- ISO 8601: "2025-03-15"
  to_date     TEXT,               -- optional end date for multi-day events
  created_at  TEXT    NOT NULL DEFAULT (datetime('now'))
);
...
INSERT OR IGNORE INTO events (mosque_id, name, description, from_date, to_date) VALUES
(1, 'Hajj Season 2025', 'Annual Hajj pilgrimage season', '2025-06-04', '2025-06-09'),
(4, 'Ramadan Night Prayer', 'Special Tarawih prayers during Ramadan', '2025-03-01', '2025-03-30'),
(5, 'Islamic Art Exhibition', 'Showcasing calligraphy and Islamic geometric art', '2025-04-15', '2025-04-20');
